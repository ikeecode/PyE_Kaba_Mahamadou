# importation du module re quon utilise avec la fonction separator
...
# tout ce qui suit permet a la verification des dates
# ce dico est indispensable pour utiliser la fonction find_month
monthabet = {
    'ja': 1,'f': 2,'mar':3,'av':4,
